...
function LenisProvider({ children }: { children: React.ReactNode }) {
  ...
  if (pathname.startsWith("/dashboard") || pathname.startsWith("/dispatch") || pathname.startsWith("/admin") || pathname.startsWith("/search") || pathname.startsWith("/chat")) return <>{children}</>;
  return (
